...
if !exists("did_todo_syntax_inits")
    ...
    hi default tCanceled ctermfg=darkblue guifg=DarkGray

    hi link tododone tDone
    hi link done tDone
    hi default tDone ctermfg=darkblue guifg=LightGray
